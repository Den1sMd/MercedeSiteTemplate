...
export default function CarPage() {
  const images = ["/gle/1.png", "/gle/2.png", "/gle/3.png"];
  ...
  const prevImage = () => {
    ...
    <div className="flex mb-20 h-full bg-zinc-800 w-full pb-7 border border-white rounded-b-md">
        <p className="text-xl ml-5 mt-5">Mercedes GLE</p>
        <p className="text-xl ml-5 mt-5">Prix : 68 900 €</p>
    </div>
    ...
    <div className="flex flex-col">
        ...
        <div className="flex flex-row justify-between">
            <p>Modèle</p>
            <p className="font-bold">Classe GLE</p>
        </div>

        <div className="flex flex-row justify-between">
            <p>Kilométrage</p>
            <p className="font-bold">59189 km</p>
        </div>
  ...
  <div className="bg-zinc-800 text-white p-4 rounded-lg shadow-md border border-zinc-700 ">
    <p className="leading-relaxed text-sm md:text-base ">
      Le Mercedes-Benz GLE est un grand SUV qui associe puissance, confort et élégance avec une présence imposante sur la route. Son intérieur spacieux et technologique offre une expérience de conduite haut de gamme.
