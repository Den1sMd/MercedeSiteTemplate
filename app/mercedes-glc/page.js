...
export default function CarPage() {
  const images = ["/glc/1.png", "/glc/2.png", "/glc/3.png"];
  ...
  const prevImage = () => {
    ...
    <div className="flex mb-20 h-full bg-zinc-800 w-full pb-7 border border-white rounded-b-md">
        <p className="text-xl ml-5 mt-5">Mercedes GLC</p>
        <p className="text-xl ml-5 mt-5">Prix : 50 900 €</p>
    </div>
    ...
    <div className="flex flex-col">
        ...
        <div className="flex flex-row justify-between">
            <p>Énergie</p>
            <p className="font-bold">Hybride</p>
        </div>
        ...
        <div className="flex flex-row justify-between">
            <p>Modèle</p>
            <p className="font-bold">Classe GLC</p>
        </div>

        <div className="flex flex-row justify-between">
            <p>Kilométrage</p>
            <p className="font-bold">82131 km</p>
        </div>
  ...
  <div className="bg-zinc-800 text-white p-4 rounded-lg shadow-md border border-zinc-700 ">
    <p className="leading-relaxed text-sm md:text-base ">
      Le Mercedes-Benz GLC est un SUV premium qui allie élégance, confort et puissance. Son design moderne aux lignes fluides reflète parfaitement l’ADN de la marque. À l’intérieur, il offre une finition haut de gamme.
